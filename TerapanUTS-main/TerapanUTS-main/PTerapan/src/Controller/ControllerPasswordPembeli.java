...
public class ControllerPasswordPembeli {
    ...
    public void Back(ActionEvent ex) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("/UI/AkunPembeli.fxml"));
        Parent root = loader.load();
        Scene new_scene = new Scene(root);
        new_stage.setScene(new_scene);
        new_stage.show();
        ControlerAkunPembeli ca = loader.getController();
        ca.isiPass(pass);
        ca.isiName(Name);
